...
def register_logging(app):
    ...
    file_handler = RotatingFileHandler(os.path.join(basedir, 'logs/treasure_house.log'),
    ...
    mail_handler = SMTPHandler(
        ...
        toaddrs=['ADMIN_EMAIL'],
        subject='TREASURE_HOUSE Application Error',
...
def register_commands(app):
    ...
    def init(username, password):
        """Building treasure_house, just for you."""
    ...
    def forge(category, post, comment):
        """Generate fake data."""
        from treasure_house.fakes import fake_admin, fake_categories, fake_posts, fake_comments, fake_links
...
def register_request_handlers(app):
    ...
    def query_profiler(response):
        for q in get_debug_queries():
            if q.duration >= app.config['TREASURE_HOUSE_SLOW_QUERY_THRESHOLD']:
                app.logger.warning(
